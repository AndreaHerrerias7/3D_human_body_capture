...
bool custom_msgs__msg__plane__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._plane.Plane", full_classname_dest, 28) == 0);
  }
  custom_msgs__msg__Plane * ros_message = _ros_message;
  {  // n
    PyObject * field = PyObject_GetAttrString(_pymsg, "n");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->n)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * custom_msgs__msg__plane__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._plane");
  ...
  {  // n
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->n);
    if (!field) {
      return NULL;
    }
    {
