...
#include "custom_msgs/msg/detail/plane__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // n
...
using _Plane__ros_msg_type = custom_msgs__msg__Plane;
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Vector3(
    &(ros_message->n), current_alignment);
  // field.name d
  {
...
static uint32_t _Plane__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__Plane(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs__msg__Plane;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
static size_t _Plane__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__Plane(
