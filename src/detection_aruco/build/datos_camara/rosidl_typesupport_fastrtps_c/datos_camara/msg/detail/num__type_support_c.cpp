...
#include "datos_camara/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
#include "datos_camara/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // vect_n

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_datos_camara
...
using _Num__ros_msg_type = datos_camara__msg__Num;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_datos_camara
size_t get_serialized_size_datos_camara__msg__Num(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Num__ros_msg_type * ros_message = static_cast<const _Num__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_datos_camara__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_datos_camara
size_t max_serialized_size_datos_camara__msg__Num(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = datos_camara__msg__Num;
    is_plain =
      (
      offsetof(DataType, d) +
      last_member_size
...
static size_t _Num__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_datos_camara__msg__Num(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, datos_camara, msg, Num)() {
